...
class SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> _uploadFile() async {
    ...
    try {
      ...
      _settingProvider
          .updateDataRealtimeDatabase(FirestoreConstants.pathUserCollection, _userId, updateInfo.toJson())
          .then((_) async {
  ...
  void _handleUpdateData() {
    ...
    _settingProvider
        .updateDataRealtimeDatabase(FirestoreConstants.pathUserCollection,
        _userId, updateInfo.toJson())
        .then((_) async {
